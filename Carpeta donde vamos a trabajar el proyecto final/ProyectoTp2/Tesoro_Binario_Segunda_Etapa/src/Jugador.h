...
private:
        ...
        int cantidadDeTesoros;			 	// Cantidad de tesoros iniciales con los que le el jugador comienza el juego
        int cantidadDeTesorosDisponibles;	// Cantidad de tesoros restantes que el jugador tiene en el campoo
        Tesoro **tesoros;
...
public:
        ...
        */
        ...
        /*
        * pre: -
        * post: Verifica la cantidad de tesoros que posee un jugador y devuelve esa cifra.
        * */
        int validarTesorosDisponibles();
